...
const PokemonCard = ({ pokemonUrl }) => {
  ...
  return (
    <div className={`hover:-translate-y-2 h-[280px] aspect-square relative border-[4px] top-0 right-0 z-10 overflow-hidden ${squareTransition ? borderStyledPokemonByPokemonType[pokemonInfo?.types[0]] + " rounded-3xl" : 'border-black rounded-full'} transition-all duration-500 bg-white`}>
